...
const Settings = (props) => {
    ...
    const [voiceSplitting, setVoiceSplitting] = useState(props.voiceSplitting ?? false)
    ...
    const updateNode = () => {
        ...
        temp[nodeIndex].data.voiceSplitting = voiceSplitting
    ...
    return (
        <div className={'h-full flex flex-col justify-between gap-12'}>
            <div className={'flex bg-gray-100 p-2 flex-col gap-2'}>
                ...
                <div className={'w-full flex flex-col gap-2'}>
                    <div onClick={() => {
                        setVoiceSplitting(!voiceSplitting)
                    }} className={'flex cursor-pointer items-center gap-3'}>
                        {voiceSplitting ? <img src={'/icons/checkbox_active.svg'}/> :
                            <img src={'/icons/checkbox.svg'}/>}
                        <p className={'text-sm'}>Разделение по голосам разговаривающих</p>
                    </div>
                </div>
            </div>
            <div onClick={() => {
